...
site = requests.get('https://webbook.nist.gov/chemistry/form-ser/').text
...
# Retrieve the file
downloader.retrieve_file()

# If the downloaded file is a zip file and you want to unzip it
#unzipped_folder = 'localpath/unzipped_folder'
#downloader.unzip_it(output_path, unzipped_folder)